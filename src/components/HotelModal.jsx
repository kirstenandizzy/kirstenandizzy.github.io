  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} onCloseStart={onCloseStart} closeDelay={closeDelay} className="modal--hotels">
      <div className="hotel-cards">
        <a href="https://www.wyndhamhotels.com/hawthorn-extended-stay/tinton-falls-new-jersey/hawthorn-suites-by-wyndham-tinton-falls/" target="_blank" rel="noopener noreferrer" className="hotel-card hotel-card--featured" style={{ '--i': 0 }}>
          <div className="hotel-card__image">
            <img src="https://www.wyndhamhotels.com/content/dam/property-images/en-us/bh/us/nj/tinton-falls/52284/52284_exterior_view_4.jpg?downsize=1800:*" alt="Hawthorn Suites by Wyndham" />
          </div>
          <div className="hotel-card__content">
            <h3>Hawthorn Suites by Wyndham</h3>
            <p className="hotel-card__address">90 Park Road, Tinton Falls, NJ 07724</p>
            <p className="hotel-card__drive-time"><strong>PSA:</strong> This hotel is currently undergoing major interior & exterior renovations to be completed by the end of June. So the place will be more modern than what the photos currently show.</p>
            <p className="hotel-card__drive-time">🚗 25 min drive</p>

            <div className="hotel-card__pills">
              <span className="pill">Room Block Available</span>
        ...
        <a href="https://www.sonesta.com/sonesta-select/nj/tinton-falls/sonesta-select-tinton-falls-eatontown?isGroupCode=true&groupCode=091926ENGI_1&checkin=2026-09-19&checkout=2026-09-21" target="_blank" rel="noopener noreferrer" className="hotel-card" style={{ '--i': 1 }}>
          <div className="hotel-card__image">
        ...
        <a href="https://www.waveresort.com/" target="_blank" rel="noopener noreferrer" className="hotel-card" style={{ '--i': 2 }}>
          <div className="hotel-card__image">
        ...
        <a href="https://www.theoysterpointhotel.com/" target="_blank" rel="noopener noreferrer" className="hotel-card" style={{ '--i': 3 }}>
          <div className="hotel-card__image">
        ...
        <a href="http://themollypitcher.com/" target="_blank" rel="noopener noreferrer" className="hotel-card" style={{ '--i': 4 }}>
          <div className="hotel-card__image">
        ...
        <a href="https://www.beachwalkseabright.com/" target="_blank" rel="noopener noreferrer" className="hotel-card" style={{ '--i': 5 }}>
          <div className="hotel-card__image">
